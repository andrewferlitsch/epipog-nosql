...
public class _Test12 {
	...
	public static void Test_Where() {
		Title( "DataStoreJSON: Where - short empty where" );
		DataStore ds = new DataStoreJSON();
		Storage s = new StorageSingleFile();
		s.Storage( "C:/tmp", "goo" );
		ds.Storage( s );
		...
		Title( "DataStoreJSON: Where - short where EQ" );
		...
		Title( "DataStoreJSON: Where - short where NE" );
		...
		Title( "DataStoreJSON: Where - short where LT" );
		...
		Title( "DataStoreJSON: Where - short where LE" );
		...
		Title( "DataStoreJSON: Where - short where GT" );
		try { d.Parse( "1"); } catch ( DataException e ) { }
		...
		Title( "DataStoreJSON: Where - short where GE" );
		...
		Title( "DataStoreJSON: Where - int where EQ" );
		d = new DataInteger(); 
		...
		Title( "DataStoreJSON: Where - int where NE" );
		d = new DataInteger(); 
		try { d.Parse( "2"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.NE;
		try {
		...
		Title( "DataStoreJSON: Where - int where LT" );
		...
		Title( "DataStoreJSON: Where - int where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - int where GT" );
		try { d.Parse( "2"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - int where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - long where EQ" );
		d = new DataLong(); 
		...
		Title( "DataStoreJSON: Where - long where NE" );
		try { d.Parse( "3"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - long where LT" );
		...
		Title( "DataStoreJSON: Where - long where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - long where GT" );
		try { d.Parse( "3"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - long where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - float where EQ" );
		d = new DataFloat(); 
		...
		Title( "DataStoreJSON: Where - float where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - float where LT" );
		...
		Title( "DataStoreJSON: Where - float where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - float where GT" );
		try { d.Parse( "1.0"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - float where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - double where EQ" );
		d = new DataDouble(); 
		...
		Title( "DataStoreJSON: Where - double where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - double where LT" );
		...
		Title( "DataStoreJSON: Where - double where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - double where GT" );
		try { d.Parse( "2.0"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - double where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - boolean where EQ" );
		d = new DataBoolean(); 
		...
		Title( "DataStoreJSON: Where - boolean where NE" );
		w.op = Where.WhereOp.NE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - char where EQ" );
		d = new DataChar(); 
		...
		Title( "DataStoreJSON: Where - char where NE" );
		w.op = Where.WhereOp.NE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - char where LT" );
		...
		Title( "DataStoreJSON: Where - char where LE" );
		...
		Title( "DataStoreJSON: Where - char where GT" );
		try { d.Parse( "a"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - char where GE" );
		w.op = Where.WhereOp.GE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - date where EQ" );
		d = new DataDate(); 
		...
		Title( "DataStoreJSON: Where - date where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - date where LT" );
		...
		Title( "DataStoreJSON: Where - date where LE" );
		w.op = Where.WhereOp.LE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - date where GT" );
		try { d.Parse( "2016-12-10"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - date where GE" );
		w.op = Where.WhereOp.GE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - time where EQ" );
		d = new DataTime(); 
		...
		Title( "DataStoreJSON: Where - time where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - time where LT" );
		...
		Title( "DataStoreJSON: Where - time where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - time where GT" );
		try { d.Parse( "12:10"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - time where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - string where EQ" );
		d = new DataString(); 
		...
		Title( "DataStoreJSON: Where - string where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreJSON: Where - string where LT" );
		d = new DataString(); 
		...
		Title( "DataStoreJSON: Where - string where LE" );
		d = new DataString(); 
		w.op = Where.WhereOp.LE; 
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: Where - string where GT" );
		d = new DataString(); 
		try { d.Parse( "ab"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
		...
		Title( "DataStoreJSON: Where - string where GE" );
		d = new DataString(); 
		w.op = Where.WhereOp.GE; 
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreJSON: multiple where GE/EQ match" );
		d = new DataShort(); 
		try { d.Parse( "1"); } catch ( DataException e ) { }
		...
		Title( "DataStoreJSON: multiple where GE/EQ no match" );
		try { d.Parse( "2"); } catch ( DataException e ) { }
		w2.value = d;try {
			res = ds.Select( fields, where );
			ds.Delete();
