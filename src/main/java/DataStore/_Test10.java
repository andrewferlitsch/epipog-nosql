...
public class _Test10 {
	...
	public static void Test_Select() {
		...
		Title( "DataStoreBinary: Select - non-existent key" );
		fields = new ArrayList<String>();
		fields.add( "foo" );
		try {
			res = ds.Select( fields, null );
	...
	public static void Test_Where() {
		Title( "DataStoreBinary: Where - short empty where" );
		DataStore ds = new DataStoreBinary();
		Storage s = new StorageSingleFile();
		s.Storage( "C:/tmp", "goo" );
		ds.Storage( s );
		...
		Title( "DataStoreBinary: Where - short where EQ" );
		...
		Title( "DataStoreBinary: Where - short where NE" );
		...
		Title( "DataStoreBinary: Where - short where LT" );
		...
		Title( "DataStoreBinary: Where - short where LE" );
		...
		Title( "DataStoreBinary: Where - short where GT" );
		try { d.Parse( "1"); } catch ( DataException e ) { }
		...
		Title( "DataStoreBinary: Where - short where GE" );
		...
		Title( "DataStoreBinary: Where - int where EQ" );
		d = new DataInteger(); 
		...
		Title( "DataStoreBinary: Where - int where NE" );
		d = new DataInteger(); 
		try { d.Parse( "2"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.NE;
		try {
		...
		Title( "DataStoreBinary: Where - int where LT" );
		...
		Title( "DataStoreBinary: Where - int where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - int where GT" );
		try { d.Parse( "2"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - int where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - long where EQ" );
		d = new DataLong(); 
		...
		Title( "DataStoreBinary: Where - long where NE" );
		try { d.Parse( "3"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - long where LT" );
		...
		Title( "DataStoreBinary: Where - long where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - long where GT" );
		try { d.Parse( "3"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - long where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - float where EQ" );
		d = new DataFloat(); 
		...
		Title( "DataStoreBinary: Where - float where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - float where LT" );
		...
		Title( "DataStoreBinary: Where - float where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - float where GT" );
		try { d.Parse( "1.0"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - float where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - double where EQ" );
		d = new DataDouble(); 
		...
		Title( "DataStoreBinary: Where - double where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - double where LT" );
		...
		Title( "DataStoreBinary: Where - double where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - double where GT" );
		try { d.Parse( "2.0"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - double where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - boolean where EQ" );
		d = new DataBoolean(); 
		...
		Title( "DataStoreBinary: Where - boolean where NE" );
		w.op = Where.WhereOp.NE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - char where EQ" );
		d = new DataChar(); 
		...
		Title( "DataStoreBinary: Where - char where NE" );
		w.op = Where.WhereOp.NE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - char where LT" );
		...
		Title( "DataStoreBinary: Where - char where LE" );
		...
		Title( "DataStoreBinary: Where - char where GT" );
		try { d.Parse( "a"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - char where GE" );
		w.op = Where.WhereOp.GE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - date where EQ" );
		d = new DataDate(); 
		...
		Title( "DataStoreBinary: Where - date where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - date where LT" );
		...
		Title( "DataStoreBinary: Where - date where LE" );
		w.op = Where.WhereOp.LE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - date where GT" );
		try { d.Parse( "2016-12-10"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - date where GE" );
		w.op = Where.WhereOp.GE; 
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - time where EQ" );
		d = new DataTime(); 
		...
		Title( "DataStoreBinary: Where - time where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - time where LT" );
		...
		Title( "DataStoreBinary: Where - time where LE" );
		w.op = Where.WhereOp.LE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - time where GT" );
		try { d.Parse( "12:10"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - time where GE" );
		w.op = Where.WhereOp.GE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - string where EQ" );
		d = new DataString(); 
		...
		Title( "DataStoreBinary: Where - string where NE" );
		w.op = Where.WhereOp.NE;
		try {
			res = ds.Select( fields, where );
		}
		...
		Title( "DataStoreBinary: Where - string where LT" );
		d = new DataString(); 
		...
		Title( "DataStoreBinary: Where - string where LE" );
		d = new DataString(); 
		w.op = Where.WhereOp.LE; 
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: Where - string where GT" );
		d = new DataString(); 
		try { d.Parse( "ab"); } catch ( DataException e ) { }
		w.op = Where.WhereOp.GT; w.value = d;
		try {
		...
		Title( "DataStoreBinary: Where - string where GE" );
		d = new DataString(); 
		w.op = Where.WhereOp.GE; 
		try {
			res = ds.Select( fields, where );
		...
		Title( "DataStoreBinary: multiple where GE/EQ match" );
		d = new DataShort(); 
		try { d.Parse( "1"); } catch ( DataException e ) { }
		...
		Title( "DataStoreBinary: multiple where GE/EQ no match" );
		try { d.Parse( "2"); } catch ( DataException e ) { }
		w2.value = d;try {
			res = ds.Select( fields, where );
			ds.Delete();
